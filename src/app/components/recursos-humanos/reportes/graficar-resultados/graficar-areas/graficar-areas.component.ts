...
@Component({
  selector: 'app-graficar-areas',
  templateUrl: './graficar-areas.component.html',
  styleUrls: ['./graficar-areas.component.css']
})
export class GraficarAreasComponent implements OnInit {
